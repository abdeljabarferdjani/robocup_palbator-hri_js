...
import './ReleaseObject.css'
import { viewAction } from '../../../../redux/actions/ViewAction';

class ReleaseObject extends Component {
	static propTypes = {};
...
export default connect(mapStateToProps, mapDispatchToProps)(ReleaseObject);